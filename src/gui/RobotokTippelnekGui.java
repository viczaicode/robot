...
public class RobotokTippelnekGui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtVelSzam2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtVelSzam2ActionPerformed(evt);
            }
        });
    ...
    private void txtVelSzam2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtVelSzam2ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtVelSzam2ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        jTextArea1.append("Három robot tippel egyet-egyet:");
        ...
        jTextArea2.append("Egy robot tippelhet háromszor:\n");
        /* az 1. tipp beállítása: */
        int szam2 = (int)(Math.random() * 10) + 1;
        int tipp = (int)(Math.random() * 10) + 1;

        /* tippelések kiírása és vizsgálata: */
        jTextArea2.append("A kitalálandó szám: " + szam2+ "\n");
        jTextArea2.append("Az 1. tipp: " + tipp + "\n");
        
        if(tipp == szam2){
            jTextArea2.append("Elsőre sikerült eltalálni!\n");
        }else{
            tipp = (int)(Math.random() * 10) + 1;
            jTextArea2.append("A 2. tipp: " + tipp+ "\n");
            if(tipp == szam2){
                jTextArea2.append("Másodikra sikerült eltalálni!\n");
            }else{
                tipp = (int)(Math.random() * 10) + 1;
                ...
                if(tipp == szam2){
                    ...
                    jTextArea2.append("Nem siekrült háromból eltalálni!\n");
                }
            }
        }
